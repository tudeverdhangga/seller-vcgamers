...
import { DataVIP, FeatureChecksType, useGetStatusVIP } from "~/services/api/request-fitur";
import { SellerStatusApproved, SellerStatusDeactivated, SellerStatusPending, SellerStatusRejected } from "~/utils/dummy/seller-status";
...
export default function VIPSellerPage() {
  ...
  const [featureChecksVIPData, setFeatureChecksVIPData] = React.useState<FeatureChecksType[]>([]);
  ...
  const handleEligibleToRegisterVip = (featureChecksVIPDataCheck: FeatureChecksType[]) => {
