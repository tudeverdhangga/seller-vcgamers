...
export const useUpdatePrice = (params: string) => {
  return useMutation({
    ...
    mutationFn: async (price: number) => {
      const res = await HTTP.put(`/product/product/update-price?${params}`, {
        price,
      });
      return res.data as ResponseProduct;
    },
...
export const useUpdateStock = (params: string) => {
  return useMutation({
    ...
    mutationFn: async (stock: number) => {
      const res = await HTTP.put(`/product/product/update-stock?${params}`, {
        stock,
      });
      return res.data as ResponseProduct;
    },
  ...
  return useMutation({
    ...
    mutationFn: async (payload: object) => {
      const res = await HTTP.post(
        "/product/product/mass-kilat-update",
        payload
      );
      return res.data as ResponseProduct;
    },
    onSuccess: () => {
      void queryClient.invalidateQueries(["bulk-kilat-value"]);
    },
  });
};
    ...
    mutationFn: async (payload: object) => {
      if (str[1] !== "") {
        const res = await HTTP.put(
          `product/product/voucher/update?${params}`,
          payload
        );
        return res.data as ResponseVoucher;
      }
...
export const useDownloadBulkProduct = (params: string) => {
  return useMutation({
    ...
    mutationFn: async () => {
      const res = await HTTPXlsx.get(
        `/product/product/export-excel-mass-update?${params}`
      );
      return res;
    },
  });
...
export const useUploadBulkProduct = () => {
  return useMutation({
    ...
    mutationFn: async (payload: FormData) => {
      const res = await HTTPUpload.post(
        "/product/product/import-excel-product",
        payload
      );
