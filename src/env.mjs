...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_SMARTECH_CREATE: z.string().min(1),
    NEXT_PUBLIC_SMARTECH_REGISTER: z.string().min(1),
    NEXT_PUBLIC_SMARTECH_IDENTITY: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_SMARTECH_CREATE: process.env.NEXT_PUBLIC_SMARTECH_CREATE,
    NEXT_PUBLIC_SMARTECH_REGISTER: process.env.NEXT_PUBLIC_SMARTECH_REGISTER,
    NEXT_PUBLIC_SMARTECH_IDENTITY: process.env.NEXT_PUBLIC_SMARTECH_IDENTITY,
